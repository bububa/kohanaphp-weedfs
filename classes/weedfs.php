...
class Weedfs
{
    ...
    public function __construct($group)
    {
        ...
        $config = Kohana::$config->load('weedfs')->get($group);
        $config['group'] = $group;
        $this->config = $config;
    ...
    {
        if( ! isset(Weedfs::$instances[$group]))
        {
            Weedfs::$instances[$group] = new Weedfs($group);
        }
        return Weedfs::$instances[$group];
    }
    /**
     *
    ...
    {
        $assignUrl = $this->config['host'] . '/dir/assign';
    ...
    {
        $lookupUrl = $this->config['host'] . '/dir/lookup';
    ...
    {
        $growUrl = $this->config['host'] . '/vol/grow';
        $growUrl .= '?count=' . $count;
    ...
    {
        $statusAddress = $this->config['host'] . '/dir/status';
    ...
    {
        $statusAddress = $this->config['host'] . '/vol/status';
